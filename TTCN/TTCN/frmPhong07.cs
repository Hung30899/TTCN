...
namespace TTCN
{
    public partial class frmPhong07 : Form
    {
        public char chonND;
        ...
        private void btnCapNhat_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Bạn có muốn cập nhật máy " + txtSoMay.Text.Trim() + " không?", "Thông báo", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
            {
                ...
                sql = "Insert into LichSu(Ten,PhongMay,MaMay,Ngay,NoiDung)" +
                    " Values(N'" + userCBKT + "',N'CNTT07',N'" + txtSoMay.Text + "',(SELECT GETDATE())," +
                ...
                sql = "Update MayTinh Set TinhTrang = N'" + cboTinhTrang.Text + "'," +
                    ...
                    " where PhongMay = 'CNTT07' AND MaMay = N'" + txtSoMay.Text + "'";
                ...
                {
                    sql = "Select * from PhanAnh Where PhongMay = 'CNTT07' AND MaMay = N'" + txtSoMay.Text + "'";
        ...
        private void btnPhananh_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Bạn có muốn gửi phản ánh không?", "Thông báo", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
            {
                ...
                " VALUES (N'" + tenGV + "',N'" + "CNTT07" + "',N'" + lblSoMay.Text + "',(SELECT GETDATE()),N'" + txtPhanAnh.Text.Trim() + "',N'Chưa xử lý')";
                Functions.RunSQL(sql);
                MessageBox.Show("Đã gửi phản ánh máy: " + lblSoMay.Text + " !", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                sql = "Update MayTinh Set TinhTrang = N'Không hoạt động' where PhongMay = 'CNTT07' AND MaMay = N'" + lblSoMay.Text + "'";
                Functions.RunSQL(sql);
                reset();
                setImage();
            }
        ...
        private void setImage()
        {
            ...
            {
                string tt = Functions.GetFieldValues("Select TinhTrang from MayTinh where mamay='" + btn.Text.Trim() + "' and phongmay ='CNTT07'");
                if (tt == "Hoạt động")
        ...
        private void frmPhong07_Load(object sender, EventArgs e)
        {
            Functions.Connect();
            setImage();
            lblTen.Text = Functions.GetFieldValues("Select TenPhongMay from PhongMay where phongmay ='CNTT07'");
            lblViTri.Text = Functions.GetFieldValues("Select DiaChi from PhongMay where phongmay ='CNTT07'");
            lblMayTot.Text = Functions.GetFieldValues("Select count(MaMay) from MayTinh where phongmay ='CNTT07' and TinhTrang =N'Hoạt động'");
            lblMayHong.Text = Functions.GetFieldValues("Select count(MaMay) from MayTinh where phongmay ='CNTT07' and TinhTrang =N'Không hoạt động'");
            lblTinhTrang.Text = Functions.GetFieldValues("Select TrangThai from PhongMay where phongmay ='CNTT07'");
            lblPMM.Text = Functions.GetFieldValues("Select CacPhanMem from MayTinh where phongmay ='CNTT07' and mamay ='M01'");
            lblSoLuong.Text = Functions.GetFieldValues("Select count(MaMay) from MayTinh where phongmay ='CNTT07'");
        ...
        private void buttons_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblMain.Text = Functions.GetFieldValues("Select Mainboard from MayTinh where mamay='" + btn.Text.Trim() + "' and phongmay ='CNTT07'");
            txtMain.Text = lblMain.Text;
            mainboard = lblMain.Text;
            lblCPU.Text = Functions.GetFieldValues("Select CPU from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT07'");
            txtCPU.Text = lblCPU.Text;
            cpu = lblCPU.Text;
            lblRAM.Text = Functions.GetFieldValues("Select RAM from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT07'");
            txtRAM.Text = lblRAM.Text;
            ram = lblRAM.Text;
            lblOCung.Text = Functions.GetFieldValues("Select OCung from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT07'");
            txtOCung.Text = lblOCung.Text;
            ocung = lblOCung.Text;
            lblManHinh.Text = Functions.GetFieldValues("Select ManHinh from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT07'");
            txtManHinh.Text = lblManHinh.Text;
            manhinh = lblManHinh.Text;
            lblBanPhim.Text = Functions.GetFieldValues("Select BanPhim from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT07'");
            txtBanPhim.Text = lblBanPhim.Text;
            banphim = lblBanPhim.Text;
            lblChuot.Text = Functions.GetFieldValues("Select Chuot from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT07'");
            txtChuot.Text = lblChuot.Text;
            chuot = lblChuot.Text;
            lblHDH.Text = Functions.GetFieldValues("Select HeDieuHanh from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT07'");
            txtHDH.Text = lblHDH.Text;
            hdh = lblHDH.Text;
            lblPM.Text = Functions.GetFieldValues("Select CacPhanMem from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT07'");
            txtPM.Text = lblPM.Text;
            phanmem = lblPM.Text;
            cboTT.Text = Functions.GetFieldValues("Select TinhTrang from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT07'");
