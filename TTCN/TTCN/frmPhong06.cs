...
namespace TTCN
{
    public partial class frmPhong06 : Form
    {
        public char chonND;
        ...
        private void btnCapNhat_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Bạn có muốn cập nhật máy " + txtSoMay.Text.Trim() + " không?", "Thông báo", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
            {
                ...
                sql = "Insert into LichSu(Ten,PhongMay,MaMay,Ngay,NoiDung)" +
                    " Values(N'" + userCBKT + "',N'CNTT06',N'" + txtSoMay.Text + "',(SELECT GETDATE())," +
        ...
        private void btnPhananh_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Bạn có muốn gửi phản ánh không?", "Thông báo", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
            {
                ...
                " VALUES (N'" + tenGV + "',N'" + "CNTT06" + "',N'" + lblSoMay.Text + "',(SELECT GETDATE()),N'" + txtPhanAnh.Text.Trim() + "',N'Chưa xử lý')";
                Functions.RunSQL(sql);
                MessageBox.Show("Đã gửi phản ánh máy: " + lblSoMay.Text + " !", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                sql = "Update MayTinh Set TinhTrang = N'Không hoạt động' where PhongMay = 'CNTT06' AND MaMay = N'" + lblSoMay.Text + "'";
                Functions.RunSQL(sql);
                reset();
                setImage();
            }
        ...
        private void setImage()
        {
            ...
            {
                string tt = Functions.GetFieldValues("Select TinhTrang from MayTinh where mamay='" + btn.Text.Trim() + "' and phongmay ='CNTT06'");
                if (tt == "Hoạt động")
        ...
        private void frmPhong06_Load(object sender, EventArgs e)
        {
            Functions.Connect();
            setImage();
            lblTen.Text = Functions.GetFieldValues("Select TenPhongMay from PhongMay where phongmay ='CNTT06'");
            lblViTri.Text = Functions.GetFieldValues("Select DiaChi from PhongMay where phongmay ='CNTT06'");
        ...
        private void buttons_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblMain.Text = Functions.GetFieldValues("Select Mainboard from MayTinh where mamay='" + btn.Text.Trim() + "' and phongmay ='CNTT06'");
            txtMain.Text = lblMain.Text;
            mainboard = lblMain.Text;
            lblCPU.Text = Functions.GetFieldValues("Select CPU from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT06'");
            txtCPU.Text = lblCPU.Text;
            cpu = lblCPU.Text;
            lblRAM.Text = Functions.GetFieldValues("Select RAM from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT06'");
            txtRAM.Text = lblRAM.Text;
            ram = lblRAM.Text;
            lblOCung.Text = Functions.GetFieldValues("Select OCung from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT06'");
            txtOCung.Text = lblOCung.Text;
            ocung = lblOCung.Text;
            lblManHinh.Text = Functions.GetFieldValues("Select ManHinh from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT06'");
            txtManHinh.Text = lblManHinh.Text;
            manhinh = lblManHinh.Text;
            lblBanPhim.Text = Functions.GetFieldValues("Select BanPhim from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT06'");
            txtBanPhim.Text = lblBanPhim.Text;
            banphim = lblBanPhim.Text;
            lblChuot.Text = Functions.GetFieldValues("Select Chuot from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT06'");
            txtChuot.Text = lblChuot.Text;
            chuot = lblChuot.Text;
            lblHDH.Text = Functions.GetFieldValues("Select HeDieuHanh from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT06'");
            txtHDH.Text = lblHDH.Text;
            hdh = lblHDH.Text;
            lblPM.Text = Functions.GetFieldValues("Select CacPhanMem from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT06'");
            txtPM.Text = lblPM.Text;
            phanmem = lblPM.Text;
            cboTT.Text = Functions.GetFieldValues("Select TinhTrang from MayTinh where mamay = '" + btn.Text.Trim() + "' and phongmay = 'CNTT06'");
